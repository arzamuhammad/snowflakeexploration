...
parser.add_argument('--input-data-4',
                    type=str,
                    required=True,
                    help='Absolute path of the data-4')

parser.add_argument('--input-data-5',
                    type=str,
                    required=True,
                    help='Absolute path of the data-5')
...
inputPath = [args.input_data_1, args.input_data_2, args.input_data_3, args.input_data_4, args.input_data_5]